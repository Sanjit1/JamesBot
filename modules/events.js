...
const commands = (message) => {
    if (message.content.startsWith("j!events create")) {
        ...
        var eventId = message.content.split("j!events edit ")[1].toUpperCase();
            ...
            if (
                ...
                var moveButtons = new MessageActionRow().addComponents([
                    ...
                    new MessageButton()
                        ...
                        .setStyle("PRIMARY"),
                    new MessageButton()
                        .setCustomId("eventsnav " + eventProps.id + " unrsvp")
                        .setLabel("UN RSVP")
                        .setStyle("PRIMARY"),
                    new MessageButton()
                        .setCustomId("eventsnav " + eventProps.id + " right")
                        .setLabel("▶")
                        .setStyle("SECONDARY")
                        .setDisabled(
                            indexOfEvents ==
    ...
    if (
        ...
        if (
            ...
            const description = new TextInputComponent()
                .setCustomId(
                    "description" + interaction.customId.split("eventsstart")[1]
                )
                .setLabel("Description")
                .setStyle("PARAGRAPH");
            ...
            const location = new TextInputComponent()
                .setCustomId(
                    "location" + interaction.customId.split("eventsstart")[1]
                )
                .setLabel("Location")
                .setStyle("SHORT");
            ...
            modal.addComponents(new MessageActionRow().addComponents(location));
        ...
        details = {
            ...
            name: interaction.fields
                .getTextInputValue(
                    "name" + interaction.customId.split("eventscreateModal")[1]
                )
                .match(filter)
                .join(""),
            ...
            date: interaction.fields
                .getTextInputValue(
                    "date" + interaction.customId.split("eventscreateModal")[1]
                )
                .match(filter)
                .join(""),
            time: interaction.fields
                .getTextInputValue(
                    "time" + interaction.customId.split("eventscreateModal")[1]
                )
                .match(filter)
                .join(""),
        ...
        if (
            ...
            if (
                ...
                details[interaction.customId.split(" ")[2]] = interaction.fields
...
const at8AM = (client) => {
    ...
    if (!Object.keys(parsedStorage.modules.events.list).length == 0) {
        ...
        showMenu = new MessageEmbed()
                ...
                Object.values(parsedStorage.modules.events.list)
                    ...
                    .map((d) => {
                        return {
                            name: d.id + ". " + d.name,
                            value:
                                moment(new Date(d.date + " " + d.time)).format(
            ...
            .setDescription("Use the buttons to navigate and RSVP to events.")
            .setFooter({
                text: "j!events",
            });
